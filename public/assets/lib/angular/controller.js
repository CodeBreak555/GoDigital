...
app.controller("HomeController", function ($scope, $http) {
    ...
    $scope.addperson = function () {
        ...
        $scope.PP.NomAvocatAss = $scope.Avocata.Id;
        $scope.PP.NomAvocatPar = $scope.Avocatp.Id;
        $scope.PP.NomAvocatCoh=$scope.Avocatc.Id;
        $scope.PP.NomAvocatAssurance = $scope.Avocats.Id;
        ...
        $scope.PP.AvocatStage = $scope.AvocatStagee.Id;
    ...
    $scope.updd = function () {
        ...
        $scope.PPP.NomAvocatAss = $scope.NAvocatAssistann.Id;
        $scope.PPP.NomAvocatPar = $scope.NAvocatPa.Id;
        $scope.PPP.NomAvocatCoh = $scope.NAvocatCo.Id;
        $scope.PPP.NomAvocatAssurance = $scope.NAssurancee.Id;
        ...
        $scope.PPP.AvocatStage = $scope.AvocatStagee.Id;
