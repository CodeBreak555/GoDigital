...
<head>
  ...
  <link href="<?php echo e(asset('assets/lib/owlcarousel/assets/owl.theme.default.min.css')); ?>" rel="stylesheet">
  ...
  <link href="<?php echo e(asset('assets/lib/modal-video/css/modal-video.min.css')); ?>" rel="stylesheet">

  <!-- Main Stylesheet File -->
  <link href="<?php echo e(asset('assets/css/style.css')); ?>" rel="stylesheet">
  <script src="<?php echo e(asset('assets/lib/angular/angular.min.js')); ?>"></script>
  <!-- =======================================================
    Theme Name: GoClub
...
<div ng-controller='HomeController' >
  ...
  <section id="hero" class="wow fadeIn">
    <div class="hero-container">
      ...
      <img src="<?php echo e(asset('assets/img/hero-img.png')); ?>" alt="Hero Imgs">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="feature-block">
            ...
            <img src="<?php echo e(asset('assets/img/svg/cloud.svg')); ?>" alt="img" class="img-fluid">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="feature-block">
            ...
            <img src="<?php echo e(asset('assets/img/svg/planet.svg')); ?>" alt="img" class="img-fluid">
            <h4>Clubs</h4>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="feature-block">
            ...
            <img src="<?php echo e(asset('assets/img/svg/asteroid.svg')); ?>" alt="img" class="img-fluid">
            <h4>Annonces</h4>
    ...
    <div class="container">
      <div class="row justify-content-center">
        ...
        <div class="col-md-5 col-lg-3">
          <img src="<?php echo e(asset('assets/img/about-img.png')); ?>" alt="About">
        </div>
 ...
 <!--==========================
  ...
  <section id="screenshots" class="padd-section text-center wow fadeInUp">
    ...
    <div class="container">
      <div class="owl-carousel owl-theme">
        ...
        <div><img src="<?php echo e(asset('assets/img/screen/1.jpg')); ?>" alt="img"></div>
        <div><img src="<?php echo e(asset('assets/img/screen/2.jpg')); ?>" alt="img"></div>
        <div><img src="<?php echo e(asset('assets/img/screen/3.jpg')); ?>" alt="img"></div>
        <div><img src="<?php echo e(asset('assets/img/screen/4.jpg')); ?>" alt="img"></div>
        <div><img src="<?php echo e(asset('assets/img/screen/5.jpg')); ?>" alt="img"></div>
        <div><img src="<?php echo e(asset('assets/img/screen/6.jpg')); ?>" alt="img"></div>
        <div><img src="<?php echo e(asset('assets/img/screen/7.jpg')); ?>" alt="img"></div>
        <div><img src="<?php echo e(asset('assets/img/screen/8.jpg')); ?>" alt="img"></div>
        <div><img src="<?php echo e(asset('assets/img/screen/9.jpg')); ?>" alt="img"></div>
  ...
  <section id="features" class="padd-section text-center wow fadeInUp">
    ...
    <div class="container">
          ...
          <div class="feature-block">
            <img src="<?php echo e(asset('assets/img/amoa.png')); ?>" alt="img" class="img-fluid">
            <h4>AMOA</h4>
...
Ses actions se basent sur une approche nouvelle, basée sur l’innovation, la co-création, la pensée analytique et intuitive, au service de son client final. Ce dernier lui permet, entre autres, de concevoir le parcours et l’usage utilisateur sur tout type de plateforme selon les meilleurs normes et standards.
          ...
          <div class="feature-block">
            <img src="<?php echo e(asset('assets/img/asdes.png')); ?>" alt="img" class="img-fluid">
            <h4>ASEDS</h4>
...
Doté de solides compétences en développement informatique, il maîtrise égalment des concepts et environnements technologiques qui lui permettent de participer à leur définition et leur structuration (bases de données, serveurs, etc.). En mesure de formaliser la documentation appropriée (guide utilisateurs, etc.), il peut par aillieurs être en charge de la maintenance et de l’évolution du produit.
          ...
          <div class="feature-block">
            <img src="<?php echo e(asset('assets/img/issn.jpg')); ?>" alt="img" class="img-fluid">
            <h4>ISSN</h4>
...
Etant le noyau concepteur et « développeur », l’ingénieur des systèmes et services numérique se caractérise par une forte capacité de management et de travail en équipe. Sa parfaite maîtrise des aspects de l’intégration d’électronique lui permet de comprendre et piloter l’exécution de l’intégralité du développement d’un système embarqué.</div>
          ...
          <div class="feature-block">
            <img src="<?php echo e(asset('assets/img/data.png')); ?>" alt="img" class="img-fluid">
...
Doté de solides compétences en mathématiques et en informatique, l’intervention du Data Engineer peut converger naturellement vers les sujets ayant trait à l’intelligence artificielle, le machine learning et des systèmes apprenants.</div>
          ...
          <div class="feature-block">
            <img src="<?php echo e(asset('assets/img/svg/cloud-computing.svg')); ?>" alt="img" class="img-fluid">
            <h4>Cloud & IoT</h4>
...
Le rôle de l’ingénieur cloud et IoT intervient et gère la relation d’interdépendance entre  l’internet des objets et le cloud. De  par ses compétences en conception, en déploiement et en administration des infrastructures cloud, il gère les échanges entre objets et le traitement des données (stockage, flux de données, élasticité des infrastructures, et autre.).</div>
          ...
          <div class="feature-block">
            <img src="<?php echo e(asset('assets/img/ict.png')); ?>" alt="img" class="img-fluid">
            <h4>Smart ICT</h4>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-md-4 col-lg-3">
          <div class="team-block bottom">
            <img src="<?php echo e(asset('assets/img/team/1.jpg')); ?>" class="img-responsive" alt="img">
       ...
       <div class="col-md-6 col-md-4 col-lg-3">
          <div class="team-block bottom">
            <img src="<?php echo e(asset('assets/img/team/2.jpg')); ?>" class="img-responsive" alt="img">
            <div class="team-content">
              <ul class="list-unstyled">
                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                <li><a href="#"><i class="fa fa-twitter"></i></a></li>
        ...
        <div class="col-md-6 col-md-4 col-lg-3">
          <div class="team-block bottom">
            <img src="<?php echo e(asset('assets/img/team/4.jpg')); ?>" class="img-responsive" alt="img">
            <div class="team-content">
              <ul class="list-unstyled">
                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                <li><a href="#"><i class="fa fa-twitter"></i></a></li>
        ...
        <div class="col-md-6 col-md-4 col-lg-3">
          <div class="team-block bottom">
            <img src="<?php echo e(asset('assets/img/team/5.jpg')); ?>" class="img-responsive" alt="img">
            <div class="team-content">
              <ul class="list-unstyled">
                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                <li><a href="#"><i class="fa fa-twitter"></i></a></li>
...
-->
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="block-blog text-left">
            <a href="#"><img src="<?php echo e(asset('assets/img/blog/blog-image-1.jpg')); ?>" alt="img"></a>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="block-blog text-left">
            <a href="#"><img src="<?php echo e(asset('assets/img/blog/blog-image-2.jpg')); ?>" class="img-responsive" alt="img"></a>
            <div class="content-blog">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="block-blog text-left">
            <a href="#"><img src="<?php echo e(asset('assets/img/blog/blog-image-3.jpg')); ?>" class="img-responsive" alt="img"></a>
            <div class="content-blog">
  ...
  <script src="<?php echo e(asset('assets/lib/jquery/jquery-migrate.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/lib/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/lib/superfish/hoverIntent.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/lib/superfish/superfish.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/lib/easing/easing.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/lib/modal-video/js/modal-video.js')); ?>"></script>
  ...
  <script src="<?php echo e(asset('assets/lib/wow/wow.min.js')); ?>"></script>
   ...
   <script src="<?php echo e(asset('assets/lib/angular/controller.js')); ?>"></script>
